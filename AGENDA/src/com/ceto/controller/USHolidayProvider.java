...
import com.ceto.controller.Holiday;
import java.util.*;

import com.mindfusion.common.*;

/**
 * Proporciona una lista con las vacaciones más comunes en Estados Unidos.
 */
public class USHolidayProvider {

  /**
   * Devuelve todos los días festivos en el intervalo de tiempo especificado.
   *
   * @param from El inicio del intervalo de tiempo.
   * @param to El final del intervalo de tiempo.
   * @return Una matriz de objetos {@link Holiday} que representa los días
   * festivos en el intervalo de interés.
   */
  ...
  /**
   * Devuelve todos los días festivos en el año especificado. 
   * @param year El año. 
   * @return Una matriz de objetos {@link Holiday} que representa las vacaciones en
   * el año de interés.
   */
  ...
  /**
   * Encuentra el Domingo de Pascua del año especificado.
   */
